...
async function runPlayground() {
    ...
    await memory.addMessage('user', 'Anh rất thích uống nước cùi mía và giải toán ma trận.');
    await memory.addMessage('assistant', 'Em nhớ rồi ạ, sở thích ẩm thực và học tập của Anh rất thú vị!');
    ...
    await memory.updateLongTermMemory('Thói quen & Sở thích (Habits & Preferences)', extractedFacts);
