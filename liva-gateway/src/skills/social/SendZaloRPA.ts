...
export const metadata = {
  ...
  description:
    "[ASK_FIRST] DEFAULT Zalo messaging tool. Browser Automation (RPA) to send personal messages via Zalo Web. NEVER use send_zalo_bot for this (that is ONLY for self-notifications).",
  kit: "SOCIAL_KIT",
  requires_hitl: true,
  parameters: {
    type: "object",
    properties: {
      targetName: {
        type: "string",
        description:
          "Recipient's name. MUST remove possessive pronouns/honorifics (e.g., 'my mom' => 'Mom', 'my wife' => 'Wife', 'friend Hung' => 'Hung'). DO NOT split or remove parts of compound/full names (e.g., 'Đức Khánh' MUST remain 'Đức Khánh').",
      },
      message: {
        type: "string",
        description: "[LOCALIZED] UNDERSTAND INTENT, DO NOT COPY VERBATIM. ROLEPLAY as user and REWRITE naturally. Example: 'Remind Khanh to help with exam at 6:30' -> 'Hey Khanh, help me with the exam at 6:30!'. Use casual language matching user's language.",
      },
    },
