...
# Skill: Clerk Sync Tracer

## Description
Guidelines and verification procedures for Clerk Webhooks, Auth Syncing, Subscription states, and Native OAuth in the Antigravity-Vibe ecosystem.
