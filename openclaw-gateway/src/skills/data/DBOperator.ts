...
export const metadata = {
  name: "db_operator",
  description: "Tương tác trực tiếp với cơ sở dữ liệu SQLite cục bộ. Chạy các lệnh SQL để trích xuất báo cáo, phân tích dữ liệu mà không cần phần mềm DB Client ngoài.",
  kit: "DATA_KIT",
  parameters: {
    type: "object",
    properties: {
