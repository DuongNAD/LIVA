...
export const metadata = {
    ...
    description: "Thêm nội dung văn bản (append text) vào cuối một tài liệu Google Docs có sẵn.",
    parameters: {
        type: "object",
        properties: {
            documentId: { type: "string", description: "ID của tài liệu Google Docs (Lấy được từ search_google_drive hoặc URL)." },
            text: { type: "string", description: "Đoạn văn bản muốn ghi tiếp vào cuối tài liệu. Sử dụng dấu \\n để xuống dòng." }
        },
