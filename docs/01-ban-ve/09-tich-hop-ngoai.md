...
- Khởi tạo: `liva-native-core/src/main.rs#async_main` và `liva-desktop/src-tauri/src/lib.rs#migrate_legacy_vault`, cùng default `LIVA_VAULT_PATH = "E:\Project\LIVA\teamwork_projects\obsidian_llm_wiki\vault"` (**hardcode absolute path máy tác giả**).
