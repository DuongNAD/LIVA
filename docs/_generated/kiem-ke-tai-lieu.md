...
| `docs/03-danh-gia/05-nang-cap-toan-dien.md` | **SPLIT** | C-roadmap | 11 | `docs/06-ke-hoach/roadmap.md`<br>`docs/99-luu-tru/bao-cao-lich-su/nang-cap-toan-dien-2026-07.md` | Việc còn mở nhập master roadmap; bằng chứng U1–U20 đóng băng. |
...
| `docs/architecture/4_tier_memory_deep_audit_report.md` | **KEEP** | A | 0 | — | Báo cáo kiểm toán chuyên sâu bộ nhớ 4 tầng. |
| `docs/architecture/4_tier_memory_optimization_blueprint.md` | **KEEP** | A | 0 | — | Bản thiết kế tối ưu hoá bộ nhớ 4 tầng. |
...
- `docs/03-danh-gia/05-nang-cap-toan-dien.md`: 11 file trỏ vào.
