...
This project is indexed by GitNexus as **LIVA** (23055 symbols, 50932 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
