# Kiến trúc Bộ nhớ LIVA (LIVA-UHM — Consolidated Brain)

Tài liệu này mô tả chi tiết về hệ thống kiến trúc bộ nhớ Hợp nhất (**LIVA Unified Hybrid Memory — LIVA-UHM**) thuộc phiên bản **H-MEM v18 (HiGMem Phase 3)** của dự án LIVA.
