...
export const metadata = {
    ...
    description: "Đọc dữ liệu từ bảng tính Google Sheets trong một vùng (range) nhất định đã định sẵn, hỗ trợ phân tích dữ liệu mảng.",
    parameters: {
        type: "object",
        properties: {
            spreadsheetId: { type: "string", description: "ID của bảng tính (từ URL)." },
            range: { type: "string", description: "Vùng dữ liệu cần đọc, VD: 'Sheet1!A1:D10' hoặc chỉ tên trang tính 'Trang tính1'." }
        },
