...
export const metadata = {
  ...
  parameters: {
    ...
    properties: {
      topic: {
        type: "string",
        description: "Macro topic for ideation. Example: 'Combining AI and Web'.",
      },
      fileLocation: {
        type: "string",
        description: "Directory to save original Research Proposal. Recommended: E:/Project/LIVA/scratch_workspace"
      }
    },
