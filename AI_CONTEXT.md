...
- **v24 Ambient Cognitive OS — 4 Hardware Optimization Pillars:**
  ...
  - **Pillar 4: Wake-Word Edge Offloading** — Frontend WASM wake-word model (~1MB, Porcupine/custom ONNX). Mic always-on at Frontend but audio data NEVER sent to Backend until wake-word detected. Global Hotkey (Alt+Space) as fallback. Backend CPU usage = 0% during silence.
