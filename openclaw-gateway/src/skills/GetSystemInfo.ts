...
export const metadata = {
    ...
    description: "Lấy thông tin cấu hình và trạng thái hiện tại của hệ thống máy tính (Hardware specs and system status), bao gồm CPU, RAM và Hệ điều hành.",
    parameters: {
        type: "object",
        properties: {},
        required: []
...
export const execute = async (): Promise<string> => {
    try {
        console.log(`[Skill: get_system_info] Đang trích xuất thông tin phần cứng (Extracting hardware info)...`);
