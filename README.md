...
- **Sakana AI & Các cộng sự (Chris Lu, David Ha...)**: Lấy cảm hứng mạnh mẽ từ báo cáo nghiên cứu *"The AI Scientist: Towards Fully Automated Open-Ended Scientific Discovery"*, giúp định hình và xây dựng vòng lặp Lập trình Tự trị (AI Scientist) cho dự án.
