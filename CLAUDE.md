...
This project is indexed by GitNexus as **LIVA** (25571 symbols, 56505 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
