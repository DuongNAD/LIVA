...
server_settings = Settings(
    ...
    # Kích hoạt Speculative Decoding
    draft_model=os.path.join(os.getenv("AI_MODELS_DIR", "E:/AI_Models"), os.getenv("DRAFT_MODEL_NAME", "gemma-2b-it-Q4_K_M.gguf")),
    draft_model_num_pred_tokens=10,
