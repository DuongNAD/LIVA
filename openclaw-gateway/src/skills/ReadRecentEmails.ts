export const metadata = {
    ...
    description: "Truy xuất (Fetch) các email mới nhất từ hộp thư của người dùng. Kỹ năng này cung cấp nội dung email thô để AI đọc và tóm tắt.",
    parameters: {
        type: "object",
        properties: {},
        required: []
...
export const execute = async (): Promise<string> => {
    try {
        console.log(`[Skill: read_recent_emails] Đang kết nối tới máy chủ Mail (Connecting to Mail Server)...`);
