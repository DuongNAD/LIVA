...
This project is indexed by GitNexus as **LIVA** (23320 symbols, 51501 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
